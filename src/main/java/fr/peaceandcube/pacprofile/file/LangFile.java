...
public class LangFile extends YamlFile {
    ...
    static {
        ...
        DEFAULT_TRANSLATIONS.put("settings_ptime", "Player time");
        DEFAULT_TRANSLATIONS.put("settings_ptime_sunrise", "Sunrise (5 AM)");
        DEFAULT_TRANSLATIONS.put("settings_ptime_day", "Day (6 AM)");
        DEFAULT_TRANSLATIONS.put("settings_ptime_morning", "Morning (7 AM)");
        DEFAULT_TRANSLATIONS.put("settings_ptime_noon", "Noon (12 PM)");
        DEFAULT_TRANSLATIONS.put("settings_ptime_afternoon", "Afternoon (3 PM)");
        DEFAULT_TRANSLATIONS.put("settings_ptime_sunset", "Sunset (6 PM)");
        DEFAULT_TRANSLATIONS.put("settings_ptime_night", "Night (8 PM)");
        DEFAULT_TRANSLATIONS.put("settings_ptime_midnight", "Midnight (12 AM)");
        DEFAULT_TRANSLATIONS.put("settings_ptime_click_left", "⇒ Left click to change player time");
        DEFAULT_TRANSLATIONS.put("settings_ptime_click_right", "⇒ Right click to reset player time");
        DEFAULT_TRANSLATIONS.put("settings_pweather", "Player weather");
        DEFAULT_TRANSLATIONS.put("settings_pweather_sun", "Sun");
        DEFAULT_TRANSLATIONS.put("settings_pweather_storm", "Storm");
        DEFAULT_TRANSLATIONS.put("settings_pweather_click_left", "⇒ Left click to change player weather");
        DEFAULT_TRANSLATIONS.put("settings_pweather_click_right", "⇒ Right click to reset player weather");
        ...
        DEFAULT_TRANSLATIONS.put("head_tickets_quest_number", "Quests done: ");
